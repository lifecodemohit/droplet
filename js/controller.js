(function() {
  ...
  define(['droplet-helper', 'droplet-coffee', 'droplet-javascript', 'droplet-csv', 'droplet-draw', 'droplet-model', 'droplet-view'], function(helper, coffee, javascript, csv, draw, model, view) {
